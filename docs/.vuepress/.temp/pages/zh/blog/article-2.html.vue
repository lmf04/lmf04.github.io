<template><div><p>近日，哈佛大学的研究团队在《自然》杂志上发表了一项重要研究成果，该研究深入剖析了哺乳动物下丘脑视前区（POA）神经元的发育轨迹，揭示了感觉输入、性别和功能等因素对其发育的显著影响，为我们理解本能行为的神经基础提供了全新的视角。
Image
Image
Image
Image
...
Image
Image</p>
<h1 id="此代码块用于设置环境-加载后续分析所需的r包" tabindex="-1"><a class="header-anchor" href="#此代码块用于设置环境-加载后续分析所需的r包"><span>此代码块用于设置环境，加载后续分析所需的R包</span></a></h1>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line"># 此代码用于生成区域化相关矩阵和指标，对应扩展图3d - k</span>
